...
\centering
\def \h{8cm}
\only<1>{\includegraphics[height=\h]{dem-0}}%
\only<2>{\includegraphics[height=\h]{dem-1}}%
\only<3>{\includegraphics[height=\h]{dem-2}}%
\only<4>{\includegraphics[height=\h]{dem-3}}%
\only<5>{\includegraphics[height=\h]{dem-4}}%
\only<6>{\includegraphics[height=\h]{dem-5}}%
\only<7>{\includegraphics[height=\h]{dem-6}}%
\only<8>{\includegraphics[height=\h]{dem-7}}%
\only<9>{\includegraphics[height=\h]{dem-8}}%
\only<10>{\includegraphics[height=\h]{dem-9}}
\end{frame}
...
\centering
\def \h{8cm}
Figure goes here. % \includegraphics[height=\h]{ocf}
\end{frame}
